    ...
    class MockScheduleManager:
        def get_time_blocks(self):
            ...
            return [
                ...
                ["08:00", "11:00", (255, 200, 100), "Morning Workout", False, False],
                ["11:00", "12:00", None, "", True, False],  # Empty block
                ["12:00", "16:00", (200, 200, 255), "Project Work", False, False],
                # ["17:00", "18:00", None, "Unavailable", False, True],  # Unavailable block
                ["16:00", "4:00", None, "", True, False],  # Empty block
